...
if &background == "dark"
    if s:moria_style == "dark"
        hi Normal ctermbg=Black ctermfg=white guibg=#202020 guifg=#ffffff gui=none

        hi CursorColumn ctermbg=DarkGray ctermfg=White guibg=#404040 gui=none
        hi CursorLine ctermbg=DarkGray ctermfg=White guibg=NONE gui=none
    elseif s:moria_style == "black"
        hi Normal ctermbg=Black ctermfg=White guibg=#000000 guifg=#d0d0d0 gui=none
    ...
    if s:moria_monochrome == 1
        ...
        hi LineNr guifg=DarkGray guibg=black gui=none
    ...
    if has("spell")
        hi SpellBad guisp=#bdcae3 gui=undercurl
    ...
    if version >= 700
        hi Visual ctermbg=LightGray ctermfg=Black guibg=#4e4e4e gui=none
    else
    ...
    hi Comment guibg=bg guifg=#a0a0a0 gui=none
    "hi Constant guibg=bg guifg=#87df71 gui=none
    hi Constant guibg=bg guifg=#8fa5d1 gui=none
    ...
    hi PreProc guibg=bg guifg=#6381be gui=none
    ...
    if s:moria_fontface == "mixed"
        ...
        hi Type guibg=bg guifg=#00a0ff gui=none
    endif
...
elseif &background == "light"
    if s:moria_style == "light"
        hi Normal ctermbg=White ctermfg=Black guibg=#dadada guifg=#000000 gui=none
